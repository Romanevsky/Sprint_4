...
public class OrderPage {
    ...
    private final static By inputRent = By.xpath(".//div[@class='Dropdown-placeholder']");//Поле Срок аренды
    private final static By selectCountRent = By.xpath("/html/body/div/div/div[2]/div[2]/div[2]/div[2]/div[5]");//Выпадающий список поля Срок аренды
    ...
    private final static By BUTTON_NEXT = By.xpath("/html/body/div/div/div[2]/div[3]/button");
      final static By ORDER_BUTTON_CENTERS = By.xpath("/html/body/div/div/div[2]/div[3]/button[2]"); //Кнопка Заказать в центре страницы

    private final static By ORDER_BUTTON_YES = By.xpath("/html/body/div/div/div[2]/div[5]/div[2]/button[2]");//Кнопка Да

    private final static By FINAL_ORDER_STATUS = By.xpath("/html/body/div/div/div[2]/div[5]/div[1]");//Надпись Заказ оформлен
    ...
    public String checkFinal(){
        if (driver.findElement(FINAL_ORDER_STATUS).isSelected() == true) {
